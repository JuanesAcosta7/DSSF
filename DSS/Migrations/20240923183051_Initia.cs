    ...
    public partial class Initia : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InfracctionId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Date = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Ubication = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RecordedSpeed = table.Column<int>(type: "int", nullable: false),
                    LimitedSpeed = table.Column<int>(type: "int", nullable: false),
                    DriverId = table.Column<int>(type: "int", nullable: false),
                    VehicleId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_infracctions", x => x.InfracctionId);
                    table.ForeignKey(
                        name: "FK_infracctions_Drivers_DriverId",
                        column: x => x.DriverId,
                        principalTable: "Drivers",
                        principalColumn: "DriverId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_infracctions_Vehicles_VehicleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_infracctions_DriverId",
                table: "infracctions",
                column: "DriverId");

            migrationBuilder.CreateIndex(
                name: "IX_infracctions_VehicleId",
                table: "infracctions",
                column: "VehicleId");
